...
class TimerBloc extends Bloc<TimerEvent, TimerState> {
  ...
  Stream<TimerState> mapEventToState(TimerEvent event) async* {
    if(event is LoadTimer) {
      ...
      yield* _mapTimerDisposeToState(event);
  ...
  Stream<TimerState> _mapDeleteTimerToState(event) {
    return null;
  }
  ...
  Stream<TimerState> _mapTimerDisposeToState(event) {
    return null;
  }
